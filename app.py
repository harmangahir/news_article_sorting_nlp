...
def predict():
    ...
    if(model_name == 'BNB'):
        ...
        return render_template("index.html", model_name = model,BNB_business_prob = business_percentage, BNB_tech_prob=tech_percentage,BNB_political_prob = politics_percentage,BNB_sport_prob = sport_percentage,BNB_entertainment_prob = entertainment_percentage,predicted_category = model_prediction)
